package neighbor.com.mbis.models.form;
...
public class Form_Body_Default {
    ...
    public void setRouteInfo(long routeId, String routeNum, int routeForm, String routeDivision) {
        ...
        byte[] m1 = Func.mergeByte(rID, Func.mergeByte(rNum1, rNum2));
        byte[] m2 = Func.mergeByte(rForm, rDivision);

        this.routeInfo = Func.mergeByte(m1, m2);
    }
    ...
    public void setGpsInfo(int locationX, int locationY, int bearing, int speed) {
        ...
        byte[] m1 = Func.mergeByte(x, y);
        byte[] m2 = Func.mergeByte(b, s);

        this.gpsInfo = Func.mergeByte(m1, m2);
    }
